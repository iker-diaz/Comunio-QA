 //get queries
const getJugadores = (campos, where) => {return `SELECT ${campos} FROM jugadores`};
...
const getJugadoresByDia = (campos) => {return `SELECT ${campos} FROM historial_jugadores WHERE fecha_registro = $1`};
